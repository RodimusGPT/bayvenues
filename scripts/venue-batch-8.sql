...
(
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8467}'::jsonb, 4.85, 134,
      'breezit'
    ),
(
      'nb-024', 'Hacienda De Las Flores by Wedgewood Weddings', 'North Bay', 'Moraga',
      'Moraga, Contra Costa County', 'Wedding venue in Moraga, Contra Costa County. Starting packages from $6,822.',
      60, 200,
      6822, 17055, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":6822}'::jsonb, 4.52, 172,
      'breezit'
    ),
(
      'mon-018', 'California Seltzer Co.', 'Monterey', 'Pacific Grove',
      'Pacific Grove, Monterey County', 'Wedding venue in Pacific Grove, Monterey County. Starting packages from $2,731.',
      45, 150,
      2731, 6828, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":2731}'::jsonb, 4.05, 226,
      'breezit'
    ),
(
      'nb-025', 'Pacheco Ranch Winery', 'North Bay', 'Novato',
      'Novato, Marin County', 'Wedding venue in Novato, Marin County. Starting packages from $4,500.',
      60, 200,
      4500, 11250, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":4500}'::jsonb, 4.4, 13,
      'breezit'
    ),
(
      'nb-026', 'North Tahoe Event Center', 'North Bay', 'Kings Beach',
      'Kings Beach, Placer County', 'Wedding venue in Kings Beach, Placer County. Starting packages from $4,950.',
      120, 400,
      4950, 12375, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":4950}'::jsonb, 4.65, 75,
      'breezit'
    ),
(
      'nb-027', 'Sierra Cider', 'North Bay', 'Mariposa',
      'Mariposa, Mariposa County', 'Wedding venue in Mariposa, Mariposa County. Starting packages from $2,000.',
      90, 300,
      2000, 5000, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":2000}'::jsonb, 4.86, 45,
      'breezit'
    ),
(
      'nb-028', 'St. Francis Winery', 'North Bay', 'Santa Rosa',
      'Santa Rosa, Sonoma County', 'Wedding venue in Santa Rosa, Sonoma County. Starting packages from $7,000.',
      60, 200,
      7000, 17500, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":7000}'::jsonb, 4.86, 17,
      'breezit'
    ),
(
      'nb-029', 'Merryvale Vineyards', 'North Bay', NULL,
      NULL, 'Wedding venue in California. Starting packages from $17,944.',
      30, 100,
      17944, 44860, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":17944}'::jsonb, 4.16, 446,
      'breezit'
    ),
(
      'pen-022', 'Golden Gate Club at The Presidio', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $14,240.',
      66, 220,
      14240, 35600, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":14240}'::jsonb, 4.49, 310,
      'breezit'
    ),
(
      'pen-023', 'Venture Retreat Center', 'Peninsula', 'Pescadero',
      'Pescadero, San Mateo County', 'Wedding venue in Pescadero, San Mateo County. Starting packages from $6,800.',
      45, 150,
      6800, 17000, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":6800}'::jsonb, 4.05, 22,
      'breezit'
    ),
(
      'nb-030', 'Sea Ranch Lodge', 'North Bay', 'Sea Ranch',
      'Sea Ranch, Sonoma County', 'Wedding venue in Sea Ranch, Sonoma County. Starting packages from $45,773.',
      33, 110,
      45773, 114433, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":45773}'::jsonb, 4.08, 319,
      'breezit'
    ),
(
      'nb-031', 'Sonoma Coast Villa', 'North Bay', 'Bodega',
      'Bodega, Sonoma County', 'Wedding venue in Bodega, Sonoma County. Starting packages from $4,000.',
      30, 100,
      4000, 10000, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":4000}'::jsonb, 4.29, 374,
      'breezit'
    ),
(
      'pen-024', 'The Hibernia', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $41,712.',
      225, 750,
      41712, 104280, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":41712}'::jsonb, 4.56, 166,
      'breezit'
    ),
(
      'nb-032', 'Winchester Estate by Wedgewood Weddings', 'North Bay', 'Meadow Vista',
      'Meadow Vista, Placer County', 'Wedding venue in Meadow Vista, Placer County. Starting packages from $7,713.',
      45, 150,
      7713, 19283, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":7713}'::jsonb, NULL, NULL,
      'breezit'
    ),
(
      'nb-033', 'Sterling Hotel by Wedgewood Weddings', 'North Bay', 'Sacramento',
      'Sacramento, Sacramento County', 'Wedding venue in Sacramento, Sacramento County. Starting packages from $6,826.',
      60, 200,
      6826, 17065, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":6826}'::jsonb, 4.55, 220,
      'breezit'
    ),
(
      'nb-034', 'San Ramon Waters by Wedgewood Weddings', 'North Bay', 'San Ramon',
      'San Ramon, Contra Costa County', 'Wedding venue in San Ramon, Contra Costa County. Starting packages from $6,760.',
      75, 250,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":6760}'::jsonb, 4.48, 430,
      'breezit'
    ),
(
      'nb-035', 'Jefferson Street Mansion by Wedgewood Weddings', 'North Bay', 'Benicia',
      'Benicia, Solano County', 'Wedding venue in Benicia, Solano County. Starting packages from $6,604.',
      60, 200,
      6604, 16510, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":6604}'::jsonb, 4.54, 280,
      'breezit'
    ),
(
      'nb-036', 'Stonetree Estate by Wedgewood Weddings', 'North Bay', 'Novato',
      'Novato, Marin County', 'Wedding venue in Novato, Marin County. Starting packages from $8,664.',
      60, 200,
      8664, 21660, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8664}'::jsonb, 4.73, 186,
      'breezit'
    ),
(
      'pen-025', 'The Pearl', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $9,503.',
      144, 480,
      9503, 23758, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":9503}'::jsonb, 4.61, 253,
      'breezit'
    ),
(
      'pen-026', 'Log Cabin at the Presidio', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $10,927.',
      36, 120,
      10927, 27318, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":10927}'::jsonb, 4.64, 123,
      'breezit'
    ),
(
      'pen-027', 'Chambers eat + drink', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $26,070.',
      45, 150,
      26070, 65175, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":26070}'::jsonb, 4.1, 1477,
      'breezit'
    ),
(
      'pen-028', 'Beacon Grand, A Union Square Hotel', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $22,226.',
      60, 200,
      22226, 55565, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":22226}'::jsonb, 4.74, 20,
      'breezit'
    ),
(
      'pen-029', 'Bay Lights Charters', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $8,581.',
      15, 49,
      8581, 21453, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8581}'::jsonb, NULL, NULL,
      'breezit'
    ),
(
      'pen-030', 'James Leary Flood Mansion', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $16,019.',
      50, 165,
      16019, 40048, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":16019}'::jsonb, 4.5, 67,
      'breezit'
    ),
(
      'pen-031', 'San Francisco City Hall', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $10,863.',
      900, 3000,
      10863, 27158, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":10863}'::jsonb, 4.5, 1502,
      'breezit'
    ),
(
      'pen-032', 'The Olympic Club', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $12,763.',
      90, 300,
      12763, 31908, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":12763}'::jsonb, NULL, NULL,
      'breezit'
    ),
(
      'pen-033', 'Fairmont San Francisco', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $10,523.',
      105, 350,
      10523, 26308, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":10523}'::jsonb, 4.32, 7450,
      'breezit'
    ),
(
      'pen-034', 'SF Museum of Modern Art', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $8,690.',
      180, 600,
      8690, 21725, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8690}'::jsonb, 4.58, 15178,
      'breezit'
    ),
(
      'pen-035', 'The University Club of San Francisco', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $17,360.',
      45, 150,
      17360, 43400, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":17360}'::jsonb, 4.48, 438,
      'breezit'
    ),
(
      'pen-036', 'The Westin St. Francis', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $21,725.',
      225, 750,
      21725, 54313, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":21725}'::jsonb, 4.09, 7128,
      'breezit'
    ),
(
      'pen-037', 'Marines Memorial Club & Hotel', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $10,933.',
      81, 270,
      10933, 27333, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":10933}'::jsonb, 4.5, 1610,
      'breezit'
    ),
(
      'pen-038', 'Bimbo''s 365 Club', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $36,777.',
      135, 450,
      36777, 91943, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":36777}'::jsonb, 4.29, 934,
      'breezit'
    ),
(
      'pen-039', 'The Marker San Francisco', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $12,460.',
      60, 200,
      12460, 31150, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":12460}'::jsonb, 4.1, 1617,
      'breezit'
    ),
(
      'pen-040', 'City View At Metreon', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $24,782.',
      150, 500,
      24782, 61955, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":24782}'::jsonb, 4.31, 76,
      'breezit'
    ),
(
      'pen-041', 'Wayfare Tavern', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $33,131.',
      15, 50,
      33131, 82828, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":33131}'::jsonb, 4.18, 6925,
      'breezit'
    ),
(
      'pen-042', 'Julia Morgan Ballroom at the Merchants Exchange', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $32,589.',
      150, 500,
      32589, 81473, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":32589}'::jsonb, 4.53, 197,
      'breezit'
    ),
(
      'pen-043', 'Presidio Chapel by Wedgewood Weddings', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $13,246.',
      45, 150,
      13246, 33115, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":13246}'::jsonb, 4.6, 37,
      'breezit'
    ),
(
      'pen-044', 'The Walt Disney Family Museum', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $8,690.',
      39, 130,
      8690, 21725, 'starting_package',
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8690}'::jsonb, 4.58, 4754,
      'breezit'
    ),
(
      'pen-045', 'Legion of Honor', 'Peninsula', 'San Francisco',
      'San Francisco, San Francisco County', 'Wedding venue in San Francisco, San Francisco County. Starting packages from $10,863.',
      129, 430,
      10863, 27158, 'starting_package',
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":10863}'::jsonb, 4.7, 3779,
      'breezit'
    ),
(
      'nb-037', 'Palm Springs Club', 'North Bay', 'Palm Springs',
      'Palm Springs, Riverside County', 'Wedding venue in Palm Springs, Riverside County. Starting packages from $1,052.',
      15, 50,
      1052, 2630, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":1052}'::jsonb, 4.5, 69,
      'breezit'
    ),
(
      'nb-038', 'Monte Verde Inn', 'North Bay', 'Foresthill',
      'Foresthill, Placer County', 'Wedding venue in Foresthill, Placer County. Starting packages from $8,044.',
      66, 220,
      8044, 20110, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":8044}'::jsonb, 4.57, 241,
      'breezit'
    ),
(
      'nb-039', 'Olivas Adobe', 'North Bay', 'Ventura',
      'Ventura, Ventura County', 'Wedding venue in Ventura, Ventura County. Starting packages from $474.',
      60, 200,
      474, 1185, 'starting_package',
      NULL, NULL, NULL,
      NULL,
      NULL, NULL, NULL,
      NULL, NULL, NULL,
      ...
      NULL, NULL,
      NULL,
      '{"source":"breezit.com","starting_from":474}'::jsonb, 4.6, 261,
      'breezit'
